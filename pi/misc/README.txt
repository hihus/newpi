...
框架简介：
	此项目为php开发框架，用来管理项目代码，代码的目标是灵活配置，强调代码规范和强代码管理

框架目录简介：
	你所看到的目录为核心+工程示例目录的总和
	logs目录：用来存放程序运行产生的日志 - 可根据自己工程配置
	  pi目录：用来存放框架核心的代码
	proj目录：用来存放项目代码 - 可根据自己工程配置
	pi/misc: 用来存放帮助文档和常用的工具。例如目录下的check_format工具会检查可能的存在工程内的代码规范，及时反馈给开发者修改
