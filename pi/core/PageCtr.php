...
class PI_PageCtr {
	...
	public function initTmpl(){
		$view_path = Conf::get('global.view_path',APP_ROOT.'view/views/');
		$view_cache_path = Conf::get('global.view_cache_path',APP_ROOT.'view/cache/');
		$view_compile_path = Conf::get('global.view_compile_path',APP_ROOT.'view/views_c/');
		if(null == $this->tpl){
